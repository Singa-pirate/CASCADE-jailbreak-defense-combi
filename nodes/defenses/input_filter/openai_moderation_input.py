...
# Uses OpenAI Moderation API to filter harmful input prompts before generation.
class OpenAIModerationInputNode(DefenseNode):
	def __init__(self):
		super().__init__()
		self.client = OpenAI()
		self.model_id = "omni-moderation-latest"
		self.label = Defense.OPENAI_MODERATION_INPUT
